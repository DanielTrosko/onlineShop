...
<div class="containter">
    ...
    <form:form method="POST" action="/user" modelAttribute="UserDTO">
        ...
        <div class="form-group">
            ...
            <form:input class="formControl" type="text" required="required" path="username" readonly="true"/>
        </div>
        <div class="form-group">
            <form:label path="password">Password</form:label>
            <form:input class="formControl" type="password" required="required" path="password" readonly="true"/>
        </div>
        <div class="form-group">
        ...
        <form:button type="submit" class="btn btn-primary" value="Submit">Save</form:button>
    </form:form>
</div>
